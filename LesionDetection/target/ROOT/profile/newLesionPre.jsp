<%-- 
    Document   : newLesionPre
    Created on : Aug. 21, 2020, 4:02:12 p.m.
    Author     : nickm
--%>
...
<html>
    ...
    <body>
        ...
        <form action="newLesion.jsp" id="partForm">
            <input type="hidden" id="bodyPart" name="part" value="" onchange="submitPart()">
        </form>
        <br>
        <br>
        <br>
