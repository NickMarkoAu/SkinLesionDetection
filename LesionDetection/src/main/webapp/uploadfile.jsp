...
<%
    ...
    String fileExtend = request.getParameter("name").replaceAll(" ", "") + request.getParameter("bodyPart");
    File newfolder = new File(filePath, fileExtend);
    newfolder.mkdir();
    filePath = filePath + fileExtend + "/";
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (!fi.isFormField()) {
                    ...
                    Thread.sleep(5000);
                    out.println("<i class='fas fa-check-circle' style='font-size: 40px; color: #12BBF0;'></i>");
                }
            }
            out.println("</body>");
            out.println("</html>");
