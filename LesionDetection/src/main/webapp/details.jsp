<%-- 
    Document   : details
    Created on : Jul. 13, 2020, 11:02:39 p.m.
    Author     : nickm
--%>
...
<html>
    ...
    <body>
        <jsp:include page="headerNoLogo.jsp" flush="true" />

        <% if (!Var.isFilled(request.getParameter("tc"))) {
    ...
    <center>
        <form action="uploadImage.jsp">
            <table style="width: 70%; border: none;">
                ...
                <tr>
                    <td>
                        <input type="hidden" name="bodyPart" id="bodyPart">
